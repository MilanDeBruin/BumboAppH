...
public class HolidayRepository
{
    ...
    public List<HolidayModel> GetHolidays(string country, DateTime startDate, DateTime endDate)
    {
        string jsonString;

        try
        {
            jsonString = Task.Run(() => this.GetAsyncHolidays(country, startDate, endDate)).Result;
        }
        catch (Exception e)
        {
            throw e;
